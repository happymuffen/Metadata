 ...
 * </ol>
 */
public class GraphicOverlay<B extends GraphicOverlay.Graphic> extends View {
    ...
    Set<BarcodeGraphic> mGraphics = new HashSet<>();
    ...
    public Set<BarcodeGraphic> getGraphics() {
        return mGraphics;
    }
    ...
    public static abstract class Graphic {
        ...
        Graphic(GraphicOverlay<BarcodeGraphic> overlay) {
            mOverlay = overlay;
        }
    ...
    public void add(Graphic graphic) {
        synchronized (mLock) {
            mGraphics.add((BarcodeGraphic) graphic);
        }
        postInvalidate();
    }
